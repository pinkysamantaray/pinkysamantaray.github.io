...
const Experiences = () => {
  return (
    <section id="experiences" className="mb-8">
      <h2 className="text-2xl font-bold mb-4 text-[var(--color-text-primary)]">{portfolioData.experiences.title}</h2>
      {portfolioData.experiences.content.map((experience: Experience, index: number) => (
        <div key={index} className="mb-4">
          <h3 className="text-xl font-semibold">{experience.title} at {experience.company}</h3>
